/* Copied from brscan4, adapted for brscan3
...
char origDir [] = "/usr/local/Brother/sane";
char realDir [] = OUT "/usr/local/Brother/sane";

char devCfgFileNameEnvVar [] = "BRSANENETDEVICE3_CFG_FILENAME";
char devCfgFileName [] = "/usr/local/Brother/sane/brsanenetdevice3.cfg";
